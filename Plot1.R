...
#****************************************************************************************************
#GETTING THE DATA (Plotting the data starts at line 59)
...
par(mfrow = c(1,1), mar = (c(4,4,3,1)), family = 'sans', font = 2)
plot1 <- hist(dataF$Global_active_power, breaks = 12, col = 'red', xlab = '', 
              ylab = "", main = 'Global Active Power',cex.axis = 0.75, cex.main = 1,
              font.axis = 2)
mtext('Global Active Power (kilowatts)', side = 1, line = 2.5, cex = 0.75)
mtext('Frequency', side = 2, line = 2.5, cex = 0.75)
dev.off()
